...
export function Spinner({ className, ...props }: IconProps) {
  return (
    <svg
      ...
      aria-hidden
      {...props}
      style={{ animation: "spin 0.7s linear infinite", ...props.style }}
    >
...
export function CoinsIcon(props: IconProps) {
  return (
    <svg {...base} {...props}>
      ...
      <path d="M9 14c-3.31 0-6 1.34-6 3s2.69 3 6 3 6-1.34 6-3" />
      <path d="M21 11c0 1.3-1.6 2.4-3.8 2.8" />
      <path d="M15 7.5c2.97.36 5.2 1.55 5.2 3" />
    </svg>
  );
}
